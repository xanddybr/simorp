...
<nav class="navbar navbar-inverse navbar-fixed-top" style="background-image: url('img/top_bar.jpg'); background-size: 53%; background-repeat: no-repeat; background-color: #192845;" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<ul class="user-menu">
					...
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg><?php echo $_COOKIE['checkUser']; ?></a>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="<?php echo ('registro-de-precos'); ?>" ><svg class="glyph stroked line-graph"><use xlink:href="#stroked-pencil"></use></svg> Registro de preço</a></li>
